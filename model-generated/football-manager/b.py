class Player:
    ...
    def effectiveness_index(self):
        return (self.goals * 5) + (self.assists * 4) + (self.passes * 0.02) + (self.interceptions * 3) + (self.tackles * 3) + (self.dribbles * 0.5) + (self.shots_on_goal * 1)

# create a player
player1 = Player("John Doe")

# update player's stats
player1.update_stats(5, 3, 100, 2, 5, 10, 3)
