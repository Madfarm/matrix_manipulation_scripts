...
meal_counts = {penguin: 0 for penguin in penguins}  # Initialize meal counts to 0 for each penguin
...
while meals_served < 100:  # Simulate 100 meals
    ...
    for penguin in penguins:
        if penguins[penguin] > 0:  # If the penguin is in the queue
            ...
            if meal_counts[penguin] > most_fed_meals:
                most_fed_penguin = penguin
                most_fed_meals = meal_counts[penguin]
...
print("Number of meals eaten by the most-fed penguin:", most_fed_meals)