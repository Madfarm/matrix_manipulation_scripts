...
class Species:
    def __init__(self, name, iucn_status, habitat, diet, unique_characteristics, id):
        ...
        self.habitat = habitat  # Habitat object
        self.diet = diet
...
def main():
    # Add some sample habitats
    add_habitat("Savannah")
    add_habitat("Forest")
